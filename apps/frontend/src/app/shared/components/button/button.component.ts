  ...
  buttonClasses = computed(() => {
    ...
    switch (this.variant) {
      case 'primary':
        ...
        break;
      case 'secondary':
        classes.push('bg-bdo-bg-elevated', 'text-bdo-text-primary', 'border', 'border-bdo-border-gold/50', 'hover:border-bdo-gold', 'hover:bg-bdo-bg-secondary', 'focus-visible:ring-bdo-gold');
        break;
      case 'danger':
